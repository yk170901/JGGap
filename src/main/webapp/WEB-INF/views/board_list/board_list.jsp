...
<script type="text/javascript" src="../resources/js/post_list.js?ver=1"></script>
		...
		<c:if test="${paging.startPage != 1 }">
			<div class="container">
				<div class="row">
					<div class="col">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="board_list.do?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}">Previous</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<c:when test="${p != paging.nowPage }">
					<div class="container">
						<div class="row">
							<div class="col">
								<ul class="pagination">
									<li class="page-item"><a class="page-link" href="board_list.do?nowPage=${p }&cntPerPage=${paging.cntPerPage}" class="paging_num">${p }</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<c:if test="${paging.endPage != paging.lastPage}">
			<div class="container">
				<div class="row">
					<div class="col">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="board_list.do?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}">Next</a></li>
						</ul>
					</div>
				</div>
			</div>
